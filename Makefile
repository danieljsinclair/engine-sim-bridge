...
# No master-branch guard: this project deploys sonar from master directly
# (single-branch SonarCloud, last-build-wins). A master-branch $(error) here
# is parse-time and kills every make target, not just sonar-scan.
