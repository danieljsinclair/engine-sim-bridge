...
private:
    ...
    static void deserializeCrankshafts(const json::JsonValue& json, Engine* engine, const std::string& ctx);
    static void deserializeExhaustSystems(const json::JsonValue& json, Engine* engine, const std::string& ctx);
    static void deserializeIntakes(const json::JsonValue& json, Engine* engine, const std::string& ctx);
    ...
    static void initializeCombustionChambers(Engine* engine);
};
